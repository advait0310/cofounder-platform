      ...
      <div style={styles.container}>
        ...
        {matches.length === 0 ? (
          <div style={styles.empty}>
            ...
            <button onClick={() => navigate('/swipe')} style={styles.primaryBtn}>
              Start Swiping
            </button>
          </div>
        ) : (
              ...
              return (
                <div key={match._id} style={styles.matchCard}>
                  ...
                  <div style={styles.cardButtons}>
                    <button onClick={() => navigate(`/messages/${match._id}`)} style={styles.chatBtn}>
                      💬 Chat
                    </button>
                    <button onClick={() => navigate(`/team/create?matchId=${match._id}`)} style={styles.teamBtn}>
                      🤝 Create Team
                    </button>
                  </div>
                </div>
